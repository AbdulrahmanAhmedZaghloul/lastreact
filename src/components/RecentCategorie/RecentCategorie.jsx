                            ...
                            <div className='product overflow-hidden'>
                                <Link to={`/CategorieDetails/${product._id}/${product?.category?.name}`}>
                                    <div className='relative'>
                                        ...
                                        <img
                                            className={`object-cover md:h-[15rem] h-[50vh] w-1/2 mx-auto md:w-full ${imageLoading[product.id] ? 'hidden' : 'block'}`}
                                            src={product?.image}
                                            alt={product?.name}
...
//                             <div className='product overflow-hidden'>
//                                 <Link to={`/CategorieDetails/${product._id}/${product?.category?.name}`}>
//                                     <img className='object-cover md:h-[15rem] h-[50vh] w-1/2 mx-auto md:w-full' src={product?.image} alt={product?.name} />
//                                     <span className='flex md:justify-start my-4 justify-center text-green-600'>{product?.name}</span>
//                                 </Link>
//                             </div>
//                         </div>
