          ...
          <div className="flex  flex-col lg:me-auto mx-auto w-3/4 justify-center items-center">
            <div className="flex flex-col  lg:w-3/4 w-full mt-10 items-center">
              ...
              <div className="mt-5 w-full flex-col">
                <h2 className="text-xl lg:text-start ms-10 text-gray-400">zaghloul </h2>
      ...
      <div className="lg:w-1/2 px-10 w-full justify-center flex items-center mx-auto p-6 pt-10 my-6 ">
        <div className="w-10/12  lg:me-auto mx-auto">
          ...
          <form className="lg:me-auto mx-auto container">
            ...
            <button className="bg-blue-500 w-3/4 flex py-2 text-center justify-center items-center my-5 rounded-md tracking-[0.1rem] text-gray-300 text-[1.1rem]">Pay </button>
          </form>
        </div>
      </div>
    </div>
...
// import Cards from 'react-credit-cards-2';
// // import 'react-credit-cards-2/dist/react-credit-cards.css';
// // import "react-credit-cards-2";

// // استيراد ملف CSS البديل
// import 'react-credit-cards-2';
...
//   return (
//     <React.Fragment>
//       <div className='my-10 bg-pink-950 py-6'>
//         <Cards
//           number={state.number}
//           expiry={state.expiry}
//           cvc={state.cvc}
